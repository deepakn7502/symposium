        ...
        <div className="container">
          <div className="guide">
            <div className="guide1">
              <p className="gt"> GUIDELINES</p>• One team per college.<br></br>{" "}
              • Each team will be given a topic ,where the two different
              company's output or products will be given.
              <br></br>• Your team has to infuse or integrate both the products
              of different company and prepare an advertisement regarding your
              hybrid product. <br></br>• For example, if the topic is Dairy Milk
              and Boat Earbuds: U have to explain how u combine both the
              products into an interesting product and make an advertisement
              ...
              each team has to prepare and then record their advertisement (Done
              ...
              minute..cause we obviously know more duration makes ad boring, So
              try not to be boring).<br></br> • Recorded content must have clear
              audio and (video) and interference during the recording is not
              appreciated.
